...
btn9 = tk.Button(buttonFrame, text="4", font=("Arial", 18))
btn10 = tk.Button(buttonFrame, text="5", font=("Arial", 18))
btn11 = tk.Button(buttonFrame, text="6", font=("Arial", 18))
...
btn12.grid(row=4, column=3, sticky="we")
